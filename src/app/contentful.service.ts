...
const DEFAULT_CONFIG = {
  credentials: {
    space: 'uci55v1bf2f0',
    accessToken: '5868e22f5e8c8c496b64721edf8d8bb7671cb6d084a48bfef147f23b8b776503',
  },
...
export class ContentfulService {
  ...
  getHomePage(query?: object): Promise<Entry<any>[]> {
    return this.cdaClient.getEntries(Object.assign({
      content_type: DEFAULT_CONFIG.contentTypeIds.homePage
    }, query))
    .then(res => res.items);
  }
